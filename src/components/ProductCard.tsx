...
const ProductCard = ({ product, onShowDetail }: ProductCardProps) => {
  ...
  return (
    <div className="card-product group">
      ...
      <div className="p-4">
        ...
        <h3 className="font-outfit font-bold text-lg text-foreground mb-1 line-clamp-1">
          {product.name}
        </h3>
        ...
        <div className="flex gap-2">
          <a
            ...
            className="btn-buy flex-1 flex items-center justify-center gap-2 text-sm"
          >
          ...
          <button
            ...
            className="w-12 h-12 rounded-2xl bg-muted flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-colors"
          >
